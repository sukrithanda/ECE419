    ...
    public void run() {
        while (true){
            ...
            try {
                ...
                } else if (incoming_packet.type == DataPacket.PLAYER_READY){
                    if(server.currentState == 0){
                ...
                } else if (incoming_packet.type == DataPacket.ADD_PLAYER){
                ...
                } else if (incoming_packet.type == DataPacket.PLAYER_KILLED){
...
//                } else if (incoming_packet.type == DataPacket.FIRE){
//                	MissileThread missileTick = new MissileThread(incoming_packet.id);
//                	missileTick.start();
                } else { 
                    if(server.currentState == 1){
...
//    		data.id = id;
//            data.type = DataPacket.MISSILE_TICK;
//    		addIncr(data);
//    		try {
//    			this.sleep(200);
